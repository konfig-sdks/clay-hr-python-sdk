...
from clay_hr_python_sdk.model.expense_reports_create_new_response import ExpenseReportsCreateNewResponse as ExpenseReportsCreateNewResponseSchema

from clay_hr_python_sdk.type.expense_reports_create_new_response import ExpenseReportsCreateNewResponse

from ...api_client import Dictionary
from clay_hr_python_sdk.pydantic.expense_reports_create_new_response import ExpenseReportsCreateNewResponse as ExpenseReportsCreateNewResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ExpenseReportsCreateNewResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ExpenseReportsCreateNewResponse
...
class CreateNew(BaseApi):
    ...
    async def acreate_new(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExpenseReportsCreateNewResponsePydantic:
        ...
        if validate:
            return ExpenseReportsCreateNewResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ExpenseReportsCreateNewResponsePydantic, raw_response.body)
