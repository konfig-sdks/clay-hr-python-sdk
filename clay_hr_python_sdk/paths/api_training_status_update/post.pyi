...
UserTrainingIdSchema = schemas.Int32Schema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'status': typing.Union[StatusSchema, str, ],
        'userTrainingId': typing.Union[UserTrainingIdSchema, decimal.Decimal, int, ],
    }
)
...
request_query_user_training_id = api_client.QueryParameter(
    name="userTrainingId",
    style=api_client.ParameterStyle.FORM,
    schema=UserTrainingIdSchema,
    required=True,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _update_user_status_mapped_args(
        ...
        if user_training_id is not None:
            _query_params["userTrainingId"] = user_training_id
    ...
    async def _aupdate_user_status_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_user_training_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/api/training/status/update',
            auth_settings=_auth,
            headers=_headers,
        )
