...
from clay_hr_python_sdk.model.people_and_permissions_get_basic_user_details_response import PeopleAndPermissionsGetBasicUserDetailsResponse as PeopleAndPermissionsGetBasicUserDetailsResponseSchema

from clay_hr_python_sdk.type.people_and_permissions_get_basic_user_details_response import PeopleAndPermissionsGetBasicUserDetailsResponse

from ...api_client import Dictionary
from clay_hr_python_sdk.pydantic.people_and_permissions_get_basic_user_details_response import PeopleAndPermissionsGetBasicUserDetailsResponse as PeopleAndPermissionsGetBasicUserDetailsResponsePydantic
...
SchemaFor200ResponseBody = PeopleAndPermissionsGetBasicUserDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PeopleAndPermissionsGetBasicUserDetailsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_basic_user_details_mapped_args(
        self,
    ...
    async def _aget_basic_user_details_oapg(
        self,
    ...
    def _get_basic_user_details_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetBasicUserDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_basic_user_details(
        self,
        name: typing.Optional[str] = None,
        page: typing.Optional[int] = None,
        page_size: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_basic_user_details_mapped_args(
            name=name,
            page=page,
            page_size=page_size,
            search=search,
        ...
        return await self._aget_basic_user_details_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_basic_user_details(
        self,
        name: typing.Optional[str] = None,
        page: typing.Optional[int] = None,
        page_size: typing.Optional[int] = None,
        ...
        return self._get_basic_user_details_oapg(
            query_params=args.query,
        )

class GetBasicUserDetails(BaseApi):
    ...
    async def aget_basic_user_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PeopleAndPermissionsGetBasicUserDetailsResponsePydantic:
        raw_response = await self.raw.aget_basic_user_details(
            name=name,
            page=page,
            page_size=page_size,
            search=search,
        ...
        if validate:
            return RootModel[PeopleAndPermissionsGetBasicUserDetailsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PeopleAndPermissionsGetBasicUserDetailsResponsePydantic, raw_response.body)
    ...
    def get_basic_user_details(
        ...
        raw_response = self.raw.get_basic_user_details(
            name=name,
            page=page,
            page_size=page_size,
            search=search,
