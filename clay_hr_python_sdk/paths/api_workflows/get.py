...
class BaseApi(api_client.Api):
    ...
    def _get_workflows_mapped_args(
        self,
    ...
    async def _aget_workflows_oapg(
        self,
...
class GetWorkflowsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_workflows(
        self,
        status: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_workflows_mapped_args(
            status=status,
        )
        return await self._aget_workflows_oapg(
    ...
    def get_workflows(
        ...
        return self._get_workflows_oapg(
            query_params=args.query,
        )

class GetWorkflows(BaseApi):
    ...
    async def aget_workflows(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_workflows(
            status=status,
            **kwargs,
        )
        if validate:
    ...
    def get_workflows(
        ...
        raw_response = self.raw.get_workflows(
            status=status,
        )
        if validate:
            return Dictionary(**raw_response.body)
