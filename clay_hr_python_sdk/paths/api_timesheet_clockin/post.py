...
from clay_hr_python_sdk.model.timesheets_clock_in409_response import TimesheetsClockIn409Response as TimesheetsClockIn409ResponseSchema
from clay_hr_python_sdk.model.timesheets_clock_in401_response import TimesheetsClockIn401Response as TimesheetsClockIn401ResponseSchema
from clay_hr_python_sdk.model.timesheets_clock_in_response import TimesheetsClockInResponse as TimesheetsClockInResponseSchema
from clay_hr_python_sdk.model.timesheets_clock_in403_response import TimesheetsClockIn403Response as TimesheetsClockIn403ResponseSchema

from clay_hr_python_sdk.type.timesheets_clock_in409_response import TimesheetsClockIn409Response
from clay_hr_python_sdk.type.timesheets_clock_in401_response import TimesheetsClockIn401Response
from clay_hr_python_sdk.type.timesheets_clock_in_response import TimesheetsClockInResponse
from clay_hr_python_sdk.type.timesheets_clock_in403_response import TimesheetsClockIn403Response

from ...api_client import Dictionary
from clay_hr_python_sdk.pydantic.timesheets_clock_in401_response import TimesheetsClockIn401Response as TimesheetsClockIn401ResponsePydantic
from clay_hr_python_sdk.pydantic.timesheets_clock_in403_response import TimesheetsClockIn403Response as TimesheetsClockIn403ResponsePydantic
from clay_hr_python_sdk.pydantic.timesheets_clock_in_response import TimesheetsClockInResponse as TimesheetsClockInResponsePydantic
from clay_hr_python_sdk.pydantic.timesheets_clock_in409_response import TimesheetsClockIn409Response as TimesheetsClockIn409ResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = TimesheetsClockInResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: TimesheetsClockInResponse
...
SchemaFor401ResponseBodyApplicationJson = TimesheetsClockIn401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: TimesheetsClockIn401Response
...
SchemaFor403ResponseBodyApplicationJson = TimesheetsClockIn403ResponseSchema


@dataclass
class ApiResponseFor403(api_client.ApiResponse):
    body: TimesheetsClockIn403Response
...
SchemaFor409ResponseBodyApplicationJson = TimesheetsClockIn409ResponseSchema


@dataclass
class ApiResponseFor409(api_client.ApiResponse):
    body: TimesheetsClockIn409Response
    ...
    async def _aclock_in_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/timesheet/clockin',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ClockInRaw(BaseApi):
    ...
    async def aclock_in(
        ...
        **kwargs,
        ...
        args = self._clock_in_mapped_args(
        ...
        return await self._aclock_in_oapg(
    ...
    def clock_in(
        ...
        return self._clock_in_oapg(
            query_params=args.query,
        )

class ClockIn(BaseApi):
    ...
    async def aclock_in(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimesheetsClockInResponsePydantic:
        raw_response = await self.raw.aclock_in(
            proceed_outside_geo_fence=proceed_outside_geo_fence,
            description=description,
            project_id=project_id,
            project_manager=project_manager,
        ...
        if validate:
            return TimesheetsClockInResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TimesheetsClockInResponsePydantic, raw_response.body)
    ...
    def clock_in(
        ...
        raw_response = self.raw.clock_in(
            proceed_outside_geo_fence=proceed_outside_geo_fence,
            description=description,
            project_id=project_id,
            project_manager=project_manager,
