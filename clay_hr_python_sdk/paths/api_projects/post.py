...
from clay_hr_python_sdk.model.project_create_new_request import ProjectCreateNewRequest as ProjectCreateNewRequestSchema

from clay_hr_python_sdk.type.project_create_new_request import ProjectCreateNewRequest

from ...api_client import Dictionary
from clay_hr_python_sdk.pydantic.project_create_new_request import ProjectCreateNewRequest as ProjectCreateNewRequestPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = ProjectCreateNewRequestSchema


request_body_project_create_new_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_mapped_args(
        ...
        if project_desc is not None:
            _body["projectDesc"] = project_desc
        if short_code is not None:
            _body["shortCode"] = short_code
    ...
    async def _acreate_new_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_project_create_new_request.serialize(body, content_type)
