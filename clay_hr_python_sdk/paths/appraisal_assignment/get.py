...
class BaseApi(api_client.Api):
    ...
    def _get_assignments_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_assignments_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/appraisal/assignment',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAssignmentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_assignments(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_assignments_mapped_args(
        )
        return await self._aget_assignments_oapg(
            **kwargs,
        )
    ...
    def get_assignments(
        ...
        return self._get_assignments_oapg(
        )

class GetAssignments(BaseApi):
    ...
    async def aget_assignments(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_assignments(
            **kwargs,
        )
        if validate:
    ...
    def get_assignments(
        ...
        raw_response = self.raw.get_assignments(
        )
        if validate:
            return Dictionary(**raw_response.body)
        return api_client.construct_model_instance(Dictionary, raw_response.body)
