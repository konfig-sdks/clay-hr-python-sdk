...
class BaseApi(api_client.Api):
    ...
    def _details_by_id_mapped_args(
        self,
        project_id: str,
    ...
    async def _adetails_by_id_oapg(
        self,
...
class DetailsByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adetails_by_id(
        self,
        project_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._details_by_id_mapped_args(
            project_id=project_id,
        )
        return await self._adetails_by_id_oapg(
    ...
    def details_by_id(
        ...
        return self._details_by_id_oapg(
            path_params=args.path,
        )

class DetailsById(BaseApi):
    ...
    async def adetails_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adetails_by_id(
            project_id=project_id,
            **kwargs,
        )
        if validate:
    ...
    def details_by_id(
        ...
        raw_response = self.raw.details_by_id(
            project_id=project_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
