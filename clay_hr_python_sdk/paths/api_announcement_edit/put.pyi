...
# Query params
AnnIdSchema = schemas.Int32Schema
TitleSchema = schemas.StrSchema
DesciptionSchema = schemas.StrSchema
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'annId': typing.Union[AnnIdSchema, decimal.Decimal, int, ],
        'title': typing.Union[TitleSchema, str, ],
        'desciption': typing.Union[DesciptionSchema, str, ],
...
request_query_ann_id = api_client.QueryParameter(
    name="annId",
...
request_query_desciption = api_client.QueryParameter(
    name="desciption",
    style=api_client.ParameterStyle.FORM,
    schema=DesciptionSchema,
    required=True,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _update_announcement_mapped_args(
        self,
        ann_id: int,
        title: str,
        desciption: str,
        ...
        if ann_id is not None:
            _query_params["annId"] = ann_id
        if title is not None:
            _query_params["title"] = title
        if desciption is not None:
            _query_params["desciption"] = desciption
        if url is not None:
    ...
    async def _aupdate_announcement_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_ann_id,
            request_query_title,
            request_query_desciption,
            request_query_url,
        ...
        request_before_hook(
            ...
            path_template='/api/announcement/edit',
            auth_settings=_auth,
            headers=_headers,
        )
...
class UpdateAnnouncementRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_announcement(
        self,
        ann_id: int,
        title: str,
        desciption: str,
        ...
        **kwargs,
        ...
        args = self._update_announcement_mapped_args(
            ann_id=ann_id,
            title=title,
        ...
        return await self._aupdate_announcement_oapg(
    ...
    def update_announcement(
        ...
        return self._update_announcement_oapg(
            query_params=args.query,
        )

class UpdateAnnouncement(BaseApi):
    ...
    async def aupdate_announcement(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_announcement(
            ann_id=ann_id,
            title=title,
            desciption=desciption,
            status=status,
    ...
    def update_announcement(
        ...
        raw_response = self.raw.update_announcement(
            ann_id=ann_id,
            title=title,
            desciption=desciption,
            status=status,
