...
class BaseApi(api_client.Api):
    ...
    def _list_allocations_mapped_args(
        self,
        project_id: int,
    ...
    async def _alist_allocations_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/projects/allocation/{projectId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListAllocationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_allocations(
        self,
        project_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_allocations_mapped_args(
            project_id=project_id,
        )
        return await self._alist_allocations_oapg(
...
class ListAllocations(BaseApi):
    ...
    async def alist_allocations(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_allocations(
            project_id=project_id,
            **kwargs,
        )
        if validate:
    ...
    def list_allocations(
        ...
        raw_response = self.raw.list_allocations(
            project_id=project_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
