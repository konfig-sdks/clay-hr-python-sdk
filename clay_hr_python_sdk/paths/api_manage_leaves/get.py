...
class BaseApi(api_client.Api):
    ...
    def _get_leaves_based_on_role_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_leaves_based_on_role_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/manage/leaves',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_leaves_based_on_role_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GetLeavesBasedOnRoleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_leaves_based_on_role(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_leaves_based_on_role_mapped_args(
        )
        return await self._aget_leaves_based_on_role_oapg(
            **kwargs,
        )
    
    def get_leaves_based_on_role(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._get_leaves_based_on_role_oapg(
        )

class GetLeavesBasedOnRole(BaseApi):
    ...
    async def aget_leaves_based_on_role(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_leaves_based_on_role(
            **kwargs,
        )
        if validate:
    ...
    def get_leaves_based_on_role(
        ...
        raw_response = self.raw.get_leaves_based_on_role(
        )
        if validate:
            return RootModel[str](raw_response.body).root
        return raw_response.body
