...
class BaseApi(api_client.Api):
    ...
    def _process_leave_by_id_mapped_args(
        self,
        leave_id: int,
        status: str,
    ...
    async def _aprocess_leave_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/process/leave',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ProcessLeaveByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aprocess_leave_by_id(
        self,
        leave_id: int,
        status: str,
        **kwargs,
        ...
        args = self._process_leave_by_id_mapped_args(
            leave_id=leave_id,
            status=status,
        )
        return await self._aprocess_leave_by_id_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def process_leave_by_id(
        self,
        leave_id: int,
        status: str,
    ) -> typing.Union[
        ...
        return self._process_leave_by_id_oapg(
            query_params=args.query,
        )

class ProcessLeaveById(BaseApi):
    ...
    async def aprocess_leave_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aprocess_leave_by_id(
            leave_id=leave_id,
            status=status,
            **kwargs,
        )
    ...
    def process_leave_by_id(
        ...
        raw_response = self.raw.process_leave_by_id(
            leave_id=leave_id,
            status=status,
        )
        if validate:
