...
from clay_hr_python_sdk.model.timesheets_create_or_update_timesheet403_response import TimesheetsCreateOrUpdateTimesheet403Response as TimesheetsCreateOrUpdateTimesheet403ResponseSchema
from clay_hr_python_sdk.model.timesheets_create_or_update_timesheet_response import TimesheetsCreateOrUpdateTimesheetResponse as TimesheetsCreateOrUpdateTimesheetResponseSchema
from clay_hr_python_sdk.model.timesheets_create_or_update_timesheet409_response import TimesheetsCreateOrUpdateTimesheet409Response as TimesheetsCreateOrUpdateTimesheet409ResponseSchema
from clay_hr_python_sdk.model.timesheets_create_or_update_timesheet401_response import TimesheetsCreateOrUpdateTimesheet401Response as TimesheetsCreateOrUpdateTimesheet401ResponseSchema

from clay_hr_python_sdk.type.timesheets_create_or_update_timesheet401_response import TimesheetsCreateOrUpdateTimesheet401Response
from clay_hr_python_sdk.type.timesheets_create_or_update_timesheet409_response import TimesheetsCreateOrUpdateTimesheet409Response
from clay_hr_python_sdk.type.timesheets_create_or_update_timesheet_response import TimesheetsCreateOrUpdateTimesheetResponse
from clay_hr_python_sdk.type.timesheets_create_or_update_timesheet403_response import TimesheetsCreateOrUpdateTimesheet403Response

from ...api_client import Dictionary
from clay_hr_python_sdk.pydantic.timesheets_create_or_update_timesheet_response import TimesheetsCreateOrUpdateTimesheetResponse as TimesheetsCreateOrUpdateTimesheetResponsePydantic
from clay_hr_python_sdk.pydantic.timesheets_create_or_update_timesheet403_response import TimesheetsCreateOrUpdateTimesheet403Response as TimesheetsCreateOrUpdateTimesheet403ResponsePydantic
from clay_hr_python_sdk.pydantic.timesheets_create_or_update_timesheet409_response import TimesheetsCreateOrUpdateTimesheet409Response as TimesheetsCreateOrUpdateTimesheet409ResponsePydantic
from clay_hr_python_sdk.pydantic.timesheets_create_or_update_timesheet401_response import TimesheetsCreateOrUpdateTimesheet401Response as TimesheetsCreateOrUpdateTimesheet401ResponsePydantic
...
ElapsedTimeSchema = schemas.DateTimeSchema
CardIdSchema = schemas.Int32Schema
DescriptionSchema = schemas.StrSchema
ClockedOutsideGeofenceSchema = schemas.Int32Schema
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'elapsedTime': typing.Union[ElapsedTimeSchema, str, datetime, ],
    }
)
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'clockedOutsideGeofence': typing.Union[ClockedOutsideGeofenceSchema, decimal.Decimal, int, ],
...
request_query_elapsed_time = api_client.QueryParameter(
    name="elapsedTime",
    style=api_client.ParameterStyle.FORM,
    schema=ElapsedTimeSchema,
    required=True,
    explode=True,
)
...
request_query_clocked_outside_geofence = api_client.QueryParameter(
    name="clockedOutsideGeofence",
    style=api_client.ParameterStyle.FORM,
    schema=ClockedOutsideGeofenceSchema,
    explode=True,
)
...
SchemaFor201ResponseBodyApplicationJson = TimesheetsCreateOrUpdateTimesheetResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: TimesheetsCreateOrUpdateTimesheetResponse
...
SchemaFor401ResponseBodyApplicationJson = TimesheetsCreateOrUpdateTimesheet401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: TimesheetsCreateOrUpdateTimesheet401Response
...
SchemaFor403ResponseBodyApplicationJson = TimesheetsCreateOrUpdateTimesheet403ResponseSchema


@dataclass
class ApiResponseFor403(api_client.ApiResponse):
    body: TimesheetsCreateOrUpdateTimesheet403Response
...
SchemaFor409ResponseBodyApplicationJson = TimesheetsCreateOrUpdateTimesheet409ResponseSchema


@dataclass
class ApiResponseFor409(api_client.ApiResponse):
    body: TimesheetsCreateOrUpdateTimesheet409Response
...
class BaseApi(api_client.Api):
    ...
    def _create_or_update_timesheet_mapped_args(
        self,
        date: date,
        project_id: int,
        ...
        clocked_outside_geofence: typing.Optional[int] = None,
        ...
        if elapsed_time is not None:
            _query_params["elapsedTime"] = elapsed_time
        if card_id is not None:
            _query_params["cardId"] = card_id
        if description is not None:
            _query_params["description"] = description
        if clocked_outside_geofence is not None:
            _query_params["clockedOutsideGeofence"] = clocked_outside_geofence
    ...
    async def _acreate_or_update_timesheet_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_elapsed_time,
            request_query_card_id,
            request_query_description,
            request_query_clocked_outside_geofence,
        ...
        request_before_hook(
            ...
            path_template='/api/timesheet/save',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _create_or_update_timesheet_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateOrUpdateTimesheetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_or_update_timesheet(
        self,
        date: date,
        project_id: int,
        elapsed_time: datetime,
        ...
        **kwargs,
        ...
        args = self._create_or_update_timesheet_mapped_args(
            date=date,
            project_id=project_id,
            elapsed_time=elapsed_time,
            card_id=card_id,
            description=description,
            clocked_outside_geofence=clocked_outside_geofence,
        ...
        return await self._acreate_or_update_timesheet_oapg(
    ...
    def create_or_update_timesheet(
        ...
        return self._create_or_update_timesheet_oapg(
            query_params=args.query,
        )

class CreateOrUpdateTimesheet(BaseApi):
    ...
    async def acreate_or_update_timesheet(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimesheetsCreateOrUpdateTimesheetResponsePydantic:
        raw_response = await self.raw.acreate_or_update_timesheet(
            date=date,
            project_id=project_id,
            elapsed_time=elapsed_time,
            card_id=card_id,
        ...
        if validate:
            return TimesheetsCreateOrUpdateTimesheetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TimesheetsCreateOrUpdateTimesheetResponsePydantic, raw_response.body)
    ...
    def create_or_update_timesheet(
        ...
        raw_response = self.raw.create_or_update_timesheet(
            date=date,
            project_id=project_id,
            elapsed_time=elapsed_time,
            card_id=card_id,
