...
class BaseApi(api_client.Api):
    ...
    def _get_user_list_mapped_args(
        self,
    ...
    async def _aget_user_list_oapg(
        self,
...
class GetUserListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_list(
        self,
        name: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_user_list_mapped_args(
            name=name,
        )
        return await self._aget_user_list_oapg(
...
class GetUserList(BaseApi):
    ...
    async def aget_user_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_list(
            name=name,
            **kwargs,
        )
        if validate:
    ...
    def get_user_list(
        ...
        raw_response = self.raw.get_user_list(
            name=name,
        )
        if validate:
            return Dictionary(**raw_response.body)
