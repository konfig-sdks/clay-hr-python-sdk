...
class SkillsCreateNewSkillRequestAssessmentModelRangeModelListItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "interpretation", "rangeMax", "rangeMin", "scoreTempId", "strangeid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "interpretation", "rangeMax", "rangeMin", "scoreTempId", "strangeid", ], str]):
    ...
    ) -> 'SkillsCreateNewSkillRequestAssessmentModelRangeModelListItem':
