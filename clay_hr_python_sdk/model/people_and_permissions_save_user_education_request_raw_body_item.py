...
class PeopleAndPermissionsSaveUserEducationRequestRawBodyItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["course", "degree", "institution", "gpa", "state", "city", "countryId", "startDate", "endDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["course", "degree", "institution", "gpa", "state", "city", "countryId", "startDate", "endDate", ], str]):
    ...
    ) -> 'PeopleAndPermissionsSaveUserEducationRequestRawBodyItem':
