...
class GoalsGetGoalResponseReviewerUserModelLocationModelAddressModelListItemCountryModel(
    schemas.DictSchema
):
    """
    ...
    ) -> 'GoalsGetGoalResponseReviewerUserModelLocationModelAddressModelListItemCountryModel':
