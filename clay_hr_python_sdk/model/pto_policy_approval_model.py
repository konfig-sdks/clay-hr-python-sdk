...
class PtoPolicyApprovalModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["approvalId", "cid", "createUserId", "flowId", "levelSequence", "relationType", "skippable", "userGroupModel", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["approvalId", "cid", "createUserId", "flowId", "levelSequence", "relationType", "skippable", "userGroupModel", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        skippable: typing.Union[MetaOapg.properties.skippable, decimal.Decimal, int, schemas.Unset] = schemas.unset,
