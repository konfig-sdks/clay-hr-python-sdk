...
class CustomFieldsGetValueResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["customFieldValueId", "customFieldId", "customFieldObjectId", "cid", "createUserId", "customfieldName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["customFieldValueId", "customFieldId", "customFieldObjectId", "cid", "createUserId", "customfieldName", ], str]):
