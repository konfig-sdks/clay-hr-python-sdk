...
class FeedbackListFeedbackResponseFeedbackListItemAssignedUserModelLocationModelAddressModelListItem(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def countryModel() -> typing.Type['FeedbackListFeedbackResponseFeedbackListItemAssignedUserModelLocationModelAddressModelListItemCountryModel']:
                return FeedbackListFeedbackResponseFeedbackListItemAssignedUserModelLocationModelAddressModelListItemCountryModel
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["countryModel"]) -> 'FeedbackListFeedbackResponseFeedbackListItemAssignedUserModelLocationModelAddressModelListItemCountryModel': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["addressId", "addressLine1", "addressLine2", "city", "currentStatus", "state", "zipCode", "createts", "cid", "userId", "candidateId", "addressType", "locationId", "contactId", "countryId", "countryModel", "status", "verificationStatus", "custId", "mapUrl", "createUserId", "extAppUID", "countryCode", "countryid", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["countryModel"]) -> typing.Union['FeedbackListFeedbackResponseFeedbackListItemAssignedUserModelLocationModelAddressModelListItemCountryModel', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        countryModel: typing.Union['FeedbackListFeedbackResponseFeedbackListItemAssignedUserModelLocationModelAddressModelListItemCountryModel', schemas.Unset] = schemas.unset,
    ...
    ) -> 'FeedbackListFeedbackResponseFeedbackListItemAssignedUserModelLocationModelAddressModelListItem':
