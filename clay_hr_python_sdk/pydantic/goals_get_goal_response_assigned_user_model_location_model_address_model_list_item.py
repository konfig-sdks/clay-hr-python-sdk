...
from clay_hr_python_sdk.pydantic.goals_get_goal_response_assigned_user_model_location_model_address_model_list_item_country_model import GoalsGetGoalResponseAssignedUserModelLocationModelAddressModelListItemCountryModel

class GoalsGetGoalResponseAssignedUserModelLocationModelAddressModelListItem(BaseModel):
    ...
    country_model: typing.Optional[GoalsGetGoalResponseAssignedUserModelLocationModelAddressModelListItemCountryModel] = Field(None, alias='countryModel')
