...
from clay_hr_python_sdk.pydantic.custom_fields_get_custom_fields_response_data_item_custom_field_group_model import CustomFieldsGetCustomFieldsResponseDataItemCustomFieldGroupModel
from clay_hr_python_sdk.pydantic.custom_fields_get_custom_fields_response_data_item_custom_field_value_model_list import CustomFieldsGetCustomFieldsResponseDataItemCustomFieldValueModelList

class CustomFieldsGetCustomFieldsResponseDataItem(BaseModel):
    ...
    custom_field_value_model_list: typing.Optional[CustomFieldsGetCustomFieldsResponseDataItemCustomFieldValueModelList] = Field(None, alias='customFieldValueModelList')

    custom_field_group_model: typing.Optional[CustomFieldsGetCustomFieldsResponseDataItemCustomFieldGroupModel] = Field(None, alias='customFieldGroupModel')
