...
from clay_hr_python_sdk.pydantic.goals_get_goal_response_assigned_user_model_location_model_address_model_list import GoalsGetGoalResponseAssignedUserModelLocationModelAddressModelList

class GoalsGetGoalResponseAssignedUserModelLocationModel(BaseModel):
    ...
    address_model_list: typing.Optional[GoalsGetGoalResponseAssignedUserModelLocationModelAddressModelList] = Field(None, alias='addressModelList')
