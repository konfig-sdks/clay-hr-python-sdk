...
from clay_hr_python_sdk.pydantic.goals_get_goal_response_reviewer_user_model_location_model_address_model_list_item_country_model import GoalsGetGoalResponseReviewerUserModelLocationModelAddressModelListItemCountryModel

class GoalsGetGoalResponseReviewerUserModelLocationModelAddressModelListItem(BaseModel):
    ...
    country_model: typing.Optional[GoalsGetGoalResponseReviewerUserModelLocationModelAddressModelListItemCountryModel] = Field(None, alias='countryModel')
